const starWarsCharacters = [
  ...
  {
    name: 'Leia Organa', //femaleNames[4]
    height: 150,
    mass: 49,
    hair_color: 'brown',
    skin_color: 'light',
  ...
  {
    name: 'Beru Whitesun lars', //femaleNames[6]
    height: 165,
    mass: 75,
    hair_color: 'brown',
    skin_color: 'light',
...
*/
for(let i=0; i<10; i++) {
  const toalNames= charactersNames.push(starWarsCharacters[i].name);

}
console.log('CHARACTERNAMES',charactersNames)
